...
The HSestimate package contains a set of R functions for the U.S. Fish and Wildlife Service Migratory Bird Program to generate harvest estimates using [Harvest Survey](https://www.fws.gov/harvestsurvey) data.
